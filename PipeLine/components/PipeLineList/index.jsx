        ...
        return (
            <Paper className={rootClassName}>
                ...
                <Row style={{ margin: 0 }}>
                    ...
                    <Col xs="8" style={{ wordWrap: 'break-word', padding: 0 }}>{product.requirement}</Col>
                </Row>
                <Row style={{ paddingBottom: 5, margin: 0 }}>
                    <Col xs="3" style={{ maxWidth: typeof window.orientation !== 'undefined' ? 104 : null, flex: typeof window.orientation !== 'undefined' ? "0 0 104px" : null, paddingRight: 0 }}>Deal Value: </Col>
                    <Col xs="8" style={{ wordWrap: 'break-word', padding: 0 }}>₹ {product.deal ? product.deal : 0}</Col>
                </Row>
